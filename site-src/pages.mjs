...
const productsBody = `${pageHero('Products', 'AI support that begins with one conversation', 'Spirantix is developing a family of agents for memory, stories, authenticity, and family possessions. You will not need to learn four different systems or decide where to begin.', '<a class="btn" href="contact.html?type=product">Ask about early access</a>')}
<section class="section section-white">
  <div class="wrap">
...
<section class="section"><div class="narrow accordion">
  ...
  <details><summary>Which products are available?</summary><div><p>Emery, Capsa, Addie, and Heri are all in beta. Product status will be updated as testing progresses.</p></div></details>
