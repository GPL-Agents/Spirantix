...
<section class="section section-soft">
  <div class="wrap">
    <div class="section-heading center">
      ...
      <p class="lede">Spirantix AI, Inc. is a non-profit founded by Greg Loeffelholz.</p>
    </div>
    <div class="callout" style="max-width:940px;margin-inline:auto;text-align:center;padding:clamp(28px,7vw,48px) clamp(20px,6vw,40px)">
      ...
      <p style="color:#fff;font-size:clamp(1.15rem,4.2vw,2rem);line-height:1.35;font-weight:600;margin-bottom:36px;text-wrap:balance">To help every senior use AI to live more confidently, independently, and meaningfully.</p>
      ...
      <p style="font-size:clamp(1.05rem,2.8vw,1.35rem);line-height:1.45;margin-bottom:0;text-wrap:balance">Spirantix helps seniors understand and safely use AI through plain-language education, community learning, and purpose-built tools that enhance their lives and preserve their legacy.</p>
    </div>
  </div>
</section>
${originStoryBody}
